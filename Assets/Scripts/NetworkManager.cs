...
public class NetworkManager : MonoBehaviour
{
    ...
    void OnOtherPlayerConnected(SocketIOEvent socketIOEvent)
    {
        ...
        //set other fields and if they are local
    ...
    public class PlayerJSON{
        ...
        public PlayerJSON(string _name, List<SpawnPoint> _playerSpawnPoints, List<SpawnPoint> _enemySpawnPoints) {
            ...
            foreach(SpawnPoint sp in _playerSpawnPoints)
            {
                PointJSON pointJSON = new PointJSON(sp);
                playerSpawnPoints.Add(pointJSON);
            }
            foreach(SpawnPoint sp in _enemySpawnPoints)
            {
                PointJSON pointJSON = new PointJSON(sp);
